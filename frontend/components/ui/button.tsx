...
function Button({
  ...
  children,
  ...props
}: Omit<ButtonPrimitive.Props, 'render' | 'children'> & ButtonOwnProps) {
  ...
  // When `asChild` is set, translate it: take the single child element
  // and hand it to Base UI's `render`, merging in our class names.
